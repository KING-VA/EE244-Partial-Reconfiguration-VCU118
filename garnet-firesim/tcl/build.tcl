...
proc garnet_synth_design {args} {
  ...
  synth_design \
    ...
    -mode out_of_context \
    {*}$args
  write_checkpoint -force "$CL_DIR/build/post_synth.dcp"
}
...
proc garnet_link_design {args} {
  link_design -mode default -top garnet_top -reconfig_partitions partition_wrapper {*}$args
